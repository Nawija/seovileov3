                        ...
                        <div class="divide-y">
                            <div class="flex flex-col gap-3 py-4 md:py-8">
                                ...
                                <p class="text-gray-600">
                                    ...
                                    biznesu. Strona pomogła mi zwiększyć zasięg
                                    i sprzedaż produktów, a także zyskać nowych
                                    klientów.
                                </p>
                            </div>
                            ...
                            <div class="flex flex-col gap-3 py-4 md:py-8">
                                ...
                                <p class="text-gray-600">
                                    Zamówienie strony internetowej było bardzo
                                    proste i bezproblemowe. Programista, z którą
                                    współpracowałem, zapewnił
                                    mi pełne wsparcie i pomoc na każdym etapie
                                    procesu.
                                </p>
                            </div>
                            ...
                            <div class="flex flex-col gap-3 py-4 md:py-8">
                                ...
                                <p class="text-gray-600">
                                Byłam bardzo zdziwionya, kiedy dowiedziałam się, że mogę zamówić profesjonalną stronę internetową za tak niską cenę. Przemyślałam, ale ostatecznie zdecydowałam się na to i byłam bardzo zadowolona z wykonanej pracy.
                                </p>
                            </div>
                        </div>
